...
#               params: { follow: new_attributes }, headers: valid_headers, as: :json
#         follow.reload
#         skip("Add assertions for updated state")
#       end

#       it "renders a JSON response with the follow" do
#         follow = Follow.create! valid_attributes
#         patch follow_url(follow),
#               params: { follow: new_attributes }, headers: valid_headers, as: :json
...
#     context "with invalid parameters" do
#       it "renders a JSON response with errors for the follow" do
#         follow = Follow.create! valid_attributes
#         patch follow_url(follow),
#               params: { follow: invalid_attributes }, headers: valid_headers, as: :json
#         expect(response).to have_http_status(:unprocessable_entity)
